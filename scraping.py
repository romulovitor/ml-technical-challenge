...
def parse_request(page_returned, depth):
    """  Responseble to get the links from the pages using a especific library
...
def extract_characteristic(url_returned, html, total_appearences):
    ...
    :param total_appearences: total of appearences
...
def read_args():
    ...
    parser.add_argument("-d", "--depth", help="How many link the function will get in after the first.", default=15)
